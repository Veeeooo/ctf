...
def create_captcha():
    ...
    width, height = 100, 40  ##指定验证码的大小
    image = Image.new('RGB', (width, height), (200, 200, 200))  ##生成画板
    font = ImageFont.truetype(font_path, height-10)   ##指定字体样式和大小
    draw = ImageDraw.Draw(image)  ##势力画笔对象
